...
$query="INSERT INTO utente (nomeutente, password, email) values (\"$nome\", \"$password\", \"$email\")";

$risultato = mysqli_query ($conn, $query) or
die ("Tabella non raggiungibile " . mysqli_error($conn) . " " . mysqli_errno($conn) );
?>
<html>
<head><title>Registrazione nuoovo utente</title>
...
if(mysqli_affected_rows($conn)){
    ...
    echo "<input type=\"submit\" value=\"torna alla registrazione\">"; 
	echo "</form>";
	}
mysqli_close($conn);
?>
